...
<head>
    ...
    <link rel="shortcut icon" href="https://milrato.com/Images/Pink.png">
    <link rel="prefetch" href="https://milrato.com/Images/Pink.png">
    ...
    <meta name="twitter:image" content="https://milrato.com/Images/Pink.png">
    ...
    <meta property="og:image" content="https://milrato.com/Images/Pink.png">
    <link rel="canonical" href="https://milrato.com" />
    <link rel="stylesheet" href="https://milrato.com/css/fontAwesome.css" />
    <link rel="stylesheet" href="https://milrato.com/css/sweetAlert.css" />
    <link rel="stylesheet" href="https://milrato.com/css/style.css" />
    <script src="https://milrato.com/js/sweetAlert.js"></script>
    <script>document.documentElement.classList.add('js')</script>
    <script src="https://milrato.com/js/script.js"></script>
</head>



<body>
  <nav class="navbar mn0">
      <div class="container">
          <button class="navbar-btn" data-toggle="collapse" data-target="#navbar-row" aria-expanded="false"aria-label="Toggle navigation">
              <span class="mn2">Open navbar menu</span>
              <span class="mn3"></span>
              <span class="mn4"></span>
              <span class="mn4"></span>
          </button>
          <div class="navbar-row" id="navbar-row">
              <ul class="navbar-col">
                  <li>
                      <a class="mn7" href="https://milrato.com/">
                          <i class="fa-solid fa-house-user"></i> &nbsp; Home
                      </a>
                  </li>
                  <li>
                      <a class="mn7" href="https://milrato.com/guide">
                          <i class="fa-solid fa-book"></i> &nbsp; Guide
                      </a>
                  </li>
              </ul>
              <ul class="navbar-col">
                  <a class="mn5" href="https://milrato.com/">
                      <img width="75" height="75" src="https://milrato.com/Images/Pink.png" />
                  </a>
              </ul>
              <ul class="navbar-col">
                  <li>
                      <a class="mn7" href="https://discord.gg/milrato" target="_blank">
                          <i class="fa-solid fa-envelope-open-text"></i> &nbsp; Support
                      </a>
                  </li>
                  <li>
                      <a class="mn7" href="https://milrato.com/invite">
                          <i class="fa-solid fa-right-to-bracket"></i> &nbsp; Invite
                      </a>
                  </li>
                  
                    <li>
                        <a class="mn13 btn btn-success" href="https://milrato.com/invite">
        ...
        <div class="row items-center">
            <div class="col lg:w-6/12">
                ...
                <div class="flex flex-col md:flex-row justify-center lg:justify-left gap-x-3 gap-y-3">
                    <a class="btn btn-primary btn-lg" href="https://milrato.com/invite" target="_blank">Invite me - Get Started ➔</a>
                    <a class="btn btn-lg btn-ghost btn-primary" href="#features">Check out my Features</a>
                </div>
            </div>
...
<section class="bg-dark static pt-0 py-1 -mt-40 -my-6" id="clients">
    <div class="container">
        <div class="row text-center lg:w-10/12 mx-auto space-x-3 space-y-3 justify-center">
            <div class="col">
                <h3 class="display-6 text-center font-semibold mb-12">Trusted by <i class="fa-solid fa-user"></i> 867.65k Users on <i class="fa-solid fa-server"></i> 5243 Servers</h3>
            </div>
            
                <div class="milrato-guild col md:w-auto">
                    <div class="logo">
                ...
                <div class="milrato-guild col md:w-auto">
                    ...
                    <div class="text">
                        ...
                        <div class="membercount text-gray-300">144.53k Members</div>
                    </div>
                </div>
                ...
                <div class="milrato-guild col md:w-auto">
                    ...
                    <div class="text">
                        ...
                        <div class="membercount text-gray-300">56.04k Members</div>
                    </div>
                </div>
                ...
                <div class="milrato-guild col md:w-auto">
                    ...
                    <div class="text">
                        ...
                        <div class="membercount text-gray-300">27.03k Members</div>
                    </div>
                </div>
                ...
                <div class="milrato-guild col md:w-auto">
                    ...
                    <div class="text">
                        ...
                        <div class="membercount text-gray-300">24.77k Members</div>
                    </div>
                </div>
                ...
                <div class="milrato-guild col md:w-auto">
                    ...
                    <div class="text">
                        ...
                        <div class="membercount text-gray-300">22.18k Members</div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col lg:w-4/12 md:w-6/12">
                <div class="p-12 rounded-t-2xl bg-neutral-700">
                    ...
                    <p class="font-normal">High-Quality fast 24/7 Audio Streams | <a class="btn btn-dark" href="#musicinfo">Music-Specs</a>
                    </p>
                </div>
            ...
            <div class="col lg:w-4/12 md:w-6/12">
                <div class="p-12 rounded-t-2xl mt-6 bg-warning-400">
                    ...
                    <p class="font-normal">Pick the Perfect Theme for you! <a class="btn btn-warning" href="#botthemes">Check it out</a>
                    </p>
                </div>
        ...
        <div class="row text-left pt-12 md:pb-12">
            <div class="col md:w-7/12 order-12 md:order-none relative">
                ...
                <img alt="product" class="max-w-full h-auto relative rounded-3xl"
                    src="https://milrato.com/Images/Mixer.png" />
            </div>
        ...
        <div class="row items-center">
            ...
            <div class="col lg:w-6/12 mt-12 lg:mt-0">
                <img class="block mx-auto lg:mr-0 pr-6 lg:max-w-[500px] w-[200vw]"
                    src="https://milrato.com/Images/Theme.png"
        ...
        <div class="row">
            <div class="col md:w-6/12 text-center mx-auto -mt-9">
                ...
                <div class="flex flex-col md:flex-row justify-center gap-x-2 gap-y-3 mb-3">
                    <a class="btn btn-primary btn-lg" href="https://milrato.com/invite" target="_blank">Add me to
                        your Server</a>
                    <a class="btn btn-lg btn-ghost btn-primary" href="https://milrato.com/dashboard">Dashboard</a>
                </div>
            </div>
        </div>
    </div>
...
<footer class="mf0" id="footer">
    <div class="container">
        <div class="row">
            <div class="col mf1">
                <a class="mf2" href="https://milrato.com/">
                    <img class="mx-auto" width="50" height="50" src="https://milrato.com/Images/Pink.png" />
                    <span class="mf3">Milrato</span> | Discord Bot
                </a>
                <div class="mf4">
                    <a class="mf5" href="https://milrato.com/terms">Terms</a>
                    <a class="mf5" href="https://milrato.com/privacy_imprint">Privacy & Imprint</a>
                    <a class="mf5" href="https://discord.gg/milrato" target="_blank">Support Server</a>
                    <a class="mf5" href="https://milrato.com/guide">Guide</a>
                </div>
                <div class="mf6">
                ...
                <div class="mf4">
                    <a class="mf7" href="https://discord.gg/milrato" title="discord" target="_blank">
                        <i class="fa-brands fa-discord text-3xl text-[#5865F2]"></i>
                    </a>
                    <a class="mf7" href="https://milrato.com/invite" title="invite">
                        <i class="fa-solid fa-right-to-bracket text-3xl"></i>
                    </a>
                    <a class="mf7" href="https://youtube.com/Tomato6966" title="youtube" target="_blank">
    ...
    <div class="mf8" style="bottom: 10px;">
        <a href="https://milrato.com/invite" target="_blank" class="mf9">
            <span>❤️ Built with Love - Invite me</span>
        </a>
    </div>
</footer>

<script src="https://milrato.com/js/webFontLoader.js"></script>
...
<script src="https://milrato.com/js/flowByte.js"></script>
<script src="https://milrato.com/js/fontAwesome.js"></script>
<script src="https://milrato.com/js/endscripts.js" ></script>
<script src="https://milrato.com/js/alerts.js"></script>
</body>
